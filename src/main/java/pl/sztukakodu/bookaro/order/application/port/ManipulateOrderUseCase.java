...
public interface ManipulateOrderUseCase {
    ...
    class PlaceOrderCommand {
        ...
        //PlaceOrderCommand nadal będzie operował na id ksiązki ale zapisywac będziemy już całą ksiązkę
        @Singular
    ...
    //nowa klasa do mapowania statusów
    @Getter
    @AllArgsConstructor
    enum Error { //większa elastyczność bo serwis nie powinien nic wiedziec o prawdziwych statusach Http
